...
const TaskCard = ({
  ...
  const getPriorityTagColor = () => {
    switch (priority) {
      case "Baja":
        return "text-emerald-500 bg-emerald-50 border border-emerald-500/50";
      case "Media":
        return "text-amber-500 bg-amber-50 border border-amber-500/50";
      default:
        return "text-rose-500 bg-rose-50 border border-rose-500/50";
    }
  };
